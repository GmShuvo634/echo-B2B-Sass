  ...
  return (
    <Sidebar className="group" collapsible="icon">
              ...
              <OrganizationSwitcher
                ...
                appearance={{
                  elements: {
                    ...
                    organizationPreviewTextContainer: "group-data-[collapsible=icon]:hidden! texst-xs! font-medium! text-sidebar-foreground!",
      ...
      <SidebarContent>
        ...
        {/* Plan & Billing */}
        <SidebarGroup>
          <SidebarGroupLabel>Accoutns</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
